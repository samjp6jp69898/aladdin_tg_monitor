...
### GET /api/overview — server.ts:150
...
### POST /api/services/restart — server.ts:155
...
### GET /api/sessions — server.ts:215
...
### GET /api/status-log — server.ts:250
...
### GET /api/pipelines — server.ts:333
...
### GET /api/toolsmith — server.ts:344
...
### GET /api/cluster/workers — server.ts:349
...
### GET /api/cluster/worker — server.ts:366
...
### POST /api/cluster/worker/disable — server.ts:395
### POST /api/cluster/worker/enable — server.ts:396
### POST /api/cluster/worker/remove — server.ts:397
...
### GET /api/agent-trace — server.ts:470
...
### POST /api/pipelines/cancel — server.ts:521
...
### POST /api/pipelines/retry — server.ts:569
...
### GET /api/tg-users — server.ts:614
...
### POST /api/tg-users/assign — server.ts:620
...
### POST /api/tg-users/unset — server.ts:630
...
### POST /api/tg-users/test — server.ts:639
...
### GET /api/token-grants — server.ts:655
...
### POST /api/token-grants/revoke — server.ts:757
...
### POST /api/token-grants/add — server.ts:772
...
### POST /api/token-grants/rename — server.ts:793
...
### POST /api/token-grants/create — server.ts:812
...
### POST /api/token-grants/resend — server.ts:828
...
### GET /api/log/tail — server.ts:877
...
### GET /api/log/since — server.ts:890
...
## GET /api/read-source — server.ts:1139（2026-09-02 Phase 8 新增）
